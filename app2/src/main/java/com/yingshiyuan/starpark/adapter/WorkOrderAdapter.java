 ...
 *@description:工单的适配器
 *@author:袁东华
 *created at 2016/7/15 0015 下午 2:10
 */
public class WorkOrderAdapter extends Adapter<WorkOrderAdapter.ViewHolder> {
    private OnItemClickListener mOnItemClickListener;
    //功能模块集合
    private List<WorkOrder> mList = new ArrayList<>();
    ...
    public void setList(List<WorkOrder> mList) {
        this.mList = mList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.workorder_item, parent, false);
