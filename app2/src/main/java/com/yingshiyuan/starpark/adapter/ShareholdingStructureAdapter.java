...
/**
 * @description:股权结构界面适配器
 * @author:袁东华 created at 2016/8/1 0001 上午 11:33
 */
public class ShareholdingStructureAdapter extends RecyclerView.Adapter<ShareholdingStructureAdapter.ViewHolder> {
    private OnItemClickListener mOnItemClickListener;
    private List<CompanyFile> mList = new ArrayList<CompanyFile>();
    private Activity activity;

    public ShareholdingStructureAdapter(Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_shareholder_structure, parent, false);
