...
/**
 * @description:营业执照界面
 * @author:袁东华 created at 2016/7/26 0026 上午 9:50
 */
@ContentView(R.layout.activity_business_licence)
public class BusinessLicenceActivity extends BaseActivity {
    ...
    private Activity activity = BusinessLicenceActivity.this;
    ...
    protected void initTopView() {
        title_tv.setText(R.string.business_licence);
    ...
    protected void initData() {
        ...
        String operatingPeriodText = operatingPeriod_et.getText().toString();
        //经营范围
        String scopeBusinessHint = getResources().getString(R.string.prompt_scope_of_business);
        String scopeBusinessText = scopeBusiness_et.getText().toString();
        //等级机关
        String departmentHint = getResources().getString(R.string.prompt_department);
        String departmentText = department_et.getText().toString();
        //邮件内容
        content = creditCodeHint + ":" + creditCodeText + "\n" +
                ...
                operatingPeriodHint + ":" + operatingPeriodText + "\n" +
                scopeBusinessHint + ":" + scopeBusinessText + "\n" +
                departmentHint + ":" + departmentText;
