...
/**
 * @description:修改法人信息界面
 * @author:袁东华 created at 2016/7/28 0028 下午 1:55
 */
@ContentView(R.layout.activity_modify_company_other_info)
public class ModifyCompanyOtherInfoActivity extends BaseActivity {
    ...
    private Activity activity = ModifyCompanyOtherInfoActivity.this;
    ...
    protected void initTopView() {
        title_tv.setText(R.string.modify_company_other_info);
    }
